...
public class CURA_ENDToEND_FLOW {
	...
	public static void main(String[] args) throws Exception {
		...
		WebElement text = driver.findElement(By.xpath("//p[contains(text(),'Please login to make appointment.')]"));
		if (text.isDisplayed()) {
			...
			System.out.println("Invalid or unexpected login page.");
		}

		/*
		 * //CHECK HISTORY driver.findElement(By.id("menu-toggle")).click();
		...
		driver.findElement(By.id("txt_visit_date")).sendKeys("31/10/1994", Keys.ENTER); // Passing comments
